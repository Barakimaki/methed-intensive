...
export const ModalDelivery = () => {
    ...
    return isOpen && <div className={style.modal}
        ...
        <div className={style.mdelivery}>
            <div className={style.container}>
                ...
                <form className={style.form} id='delivery' onSubmit={handleSubmit}>
                    ...
                    {form.format === 'delivery' && <fieldset className={style.fieldset}>
                        <input
                            className={style.input}
                            type='text'
                            name='address'
            ...
            <button className={style.modal__close} onClick={() => dispatch(closeModal())} type='button'>
                <svg
                    width='24'
                    height='24'
                    viewBox='0 0 24 24'
